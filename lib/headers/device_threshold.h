...
extern int Threshold_for_periodicity(float *d_input, ushort *d_input_harms, float *d_output_list, int *gmem_pos, float threshold, int primary_size, int secondary_size, int DM_shift, int max_list_size);
