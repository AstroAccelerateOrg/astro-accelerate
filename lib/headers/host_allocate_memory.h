...
void allocate_memory_MSD(float **d_MSD_workarea, unsigned short **d_MSD_output_taps, float **d_MSD_interpolated, float **h_MSD_interpolated, float **h_MSD_DIT, int **gmem_peak, unsigned long int MSD_maxtimesamples, int h_MSD_DIT_width, int nTimeSamples, size_t MSD_profile_size);
