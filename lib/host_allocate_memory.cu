...
void allocate_memory_cpu_output(int num_tchunks, int range, int *ndms, int **t_processed, float ****output_buffer,
                                float **d_output, size_t *outputsize)
{
...
void allocate_memory_gpu(int maxshift, int max_ndms, int nchans, int **t_processed,
