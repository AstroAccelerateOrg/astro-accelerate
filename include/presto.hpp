...
#define POWER(r, i) \
  (powargr = (r), powargi = (i), powargr * powargr + powargi * powargi)
#endif
...
#define PHASE(r, i)                                               \
  (phsargr = (r),                                                 \
   phsargi = (i),                                                 \
   ((phstmp = RADTODEG * atan2(phsargi, phsargr)) > 0.0) ? phstmp \
                                                         : phstmp + 360.0)
#endif
...
#define RADIAN_PHASE(r, i) \
  (radargr = (r),          \
   radargi = (i),          \
   ((radtmp = atan2(radargi, radargr)) > 0.0) ? radtmp : radtmp + TWOPI)
#endif
