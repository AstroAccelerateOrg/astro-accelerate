...
namespace astroaccelerate {
  ...
  int jerk_search_from_ddtr_plan(float ***dedispersed_data, JERK_Plan user_plan, float *dm_low, float *dm_step, int *list_of_ndms, float sampling_time, int *inBin, int nRanges);
