...
extern void SPDT_peak_find(float *                           d_output_SNR,
...
extern void PEAK_FIND_FOR_FDAS(float *       d_ffdot_plane,
                               float *       d_peak_list,
                               float *       d_MSD,
                               int           nDMs,
                               int           nTimesamples,
...
extern void Peak_find_for_periodicity_search_old(float * d_input_SNR,
...
extern void Peak_find_for_periodicity_search(float * d_input_SNR,
                                             ushort *d_input_harmonics,
                                             float * d_peak_list,
                                             int     nDMs,
                                             int     nTimesamples,
