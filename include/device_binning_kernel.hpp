...
void call_kernel_bin(const dim3 &num_blocks, const dim3 &threads_per_block, const unsigned short *const d_input, const float *const d_output, const int &in_nsamp);
