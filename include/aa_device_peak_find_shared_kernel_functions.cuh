...
__device__ __inline__ unsigned short does_thread_contains_peak(float *my_value, const float *d_input, int idxX, int idxY, int width, int height, float threshold, int offset){
