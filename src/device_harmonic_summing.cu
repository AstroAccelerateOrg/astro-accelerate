...
void periodicity_simple_harmonic_summing_old(float*  d_input,
                                             float*  d_output_SNR,
  ...
  call_kernel_PHS_GPU_kernel_old(gridSize,
                                 blockSize,
                                 d_input,
                                 d_output_SNR,
                                 d_output_harmonics,
...
void periodicity_simple_harmonic_summing(float*  d_input,
                                         float*  d_output_SNR,
                                         ushort* d_output_harmonics,
                                         float*  d_MSD,
                                         int     nTimesamples,
  ...
  cudaDeviceSetCacheConfig(cudaFuncCachePreferL1);
  cudaDeviceSetSharedMemConfig(cudaSharedMemBankSizeFourByte);
  call_kernel_PHS_GPU_kernel(gridSize,
                             blockSize,
                             d_input,
                             d_output_SNR,
                             d_output_harmonics,
