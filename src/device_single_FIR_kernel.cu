...
void call_kernel_PD_FIR_GPU(dim3 grid_size, dim3 block_size, int SM_size, float const* __restrict__ d_input, float *d_output, int nTaps, int nLoops, int nTimesamples) {
  PD_FIR_GPU<<<grid_size, block_size, SM_size>>>(d_input, d_output, nTaps, nLoops, nTimesamples);
}

void call_kernel_PD_FIR_GPUv1(dim3 grid_size, dim3 block_size, int SM_size, float const* __restrict__ d_input, float *d_output, int nTaps, int nLoops, unsigned int nTimesamples) {
