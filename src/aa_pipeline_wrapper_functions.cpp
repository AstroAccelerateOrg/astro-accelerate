...
namespace astroaccelerate {
  ...
  void dedisperse_telescope_data(const aa_filterbank_metadata &filterbank_data, const aa_compute::pipeline_option &pipeline_options, std::vector<aa_ddtr_plan::dm> dm_ranges, unsigned short const*const input_data) {
    ...
    aa_pipeline_generic(selected_modules, pipeline_options, filterbank_data, dm_ranges, input_data);
  }
  ...
  void dedisperse_analyse_telescope_data(const aa_filterbank_metadata &filterbank_data,
    ...
    aa_pipeline_generic(selected_modules, pipeline_options, filterbank_data, dm_ranges, input_data, sigma_cutoff, sigma_constant, max_boxcar_width_in_sec, enable_candidate_algorithm, enable_sps_baseline_noise_algorithm);
  }
