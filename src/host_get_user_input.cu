/* This module recieves user input from the CLI and then opens the input data
 * file. The input data file should always be the last argument on the CLI.
 */
