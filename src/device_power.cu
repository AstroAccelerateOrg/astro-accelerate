...
void power_gpu(cudaEvent_t   event,
               cudaStream_t  stream,
               int           samps,
               int           acc,
  ...
  call_kernel_power_kernel(num_blocks,
                           threads_per_block,
                           0,
                           stream,
                           half_samps,
...
void simple_power_and_interbin(float2* d_input,
  ...
  call_kernel_GPU_simple_power_and_interbin_kernel(gridSize,
                                                   blockDim,
                                                   d_input,
                                                   d_power_output,
                                                   d_interbin_output,
