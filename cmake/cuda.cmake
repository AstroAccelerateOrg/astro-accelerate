...
if(ENABLE_CUDA)
  ...
  list(APPEND CUDA_NVCC_FLAGS -DENABLE_CUDA -g -lineinfo -Xcompiler -fopenmp -O3 -lm --use_fast_math --ptxas-options=-v -lcuda -lcudart  -lcurand -lcufft -lcudadevrt -Xptxas  -dlcm=cg)
