...
if(ENABLE_CUDA)
  ...
  list(APPEND CUDA_NVCC_FLAGS -DENABLE_CUDA -g -std=c++11 -lineinfo -Xcompiler -fopenmp -O3 -lm --use_fast_math --ptxas-options=-v -lcuda -lcudart  -lcurand -lcufft -Xptxas  -dlcm=cg)
