...
| periodicity  | Performs a periodic peak finding analysis of dedispersed data.   | aa_periodicity_plan / aa_periodicity_strategy | **plan**: sigma_cutoff, sigma_constant, nHarmonics, export_powers, candidate_algorithm (flag), enable_outlier_rejection (flag). <br> **strategy**: aa_periodicity_plan.                     | Output saved to disk in bespoke format.                                                                                         |
| fdas         | Fourier Domain Accelerated Search of the dedispersed data.       | aa_fdas_plan / aa_fdas_strategy               | **plan**: sigma_cutoff, sigma_constant, num_boots, num_trial_bins, navdms, narrow, wide, nsearch, aggression. <br> **strategy**: aa_fdas_plan.                                                                   | Output saved to disk in bespoke format.                                                                                         |
