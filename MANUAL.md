...
| fdas         | Fourier Domain Accelerated Search of the dedispersed data.       | aa_fdas_plan / aa_fdas_strategy               | **plan**: sigma_cutoff, sigma_constant, num_boots, num_trial_bins, navdms, narrow, wide, nsearch, aggression, enable_msd_baseline_noise. <br> **strategy**: aa_fdas_plan.                                                                   | Output saved to disk in bespoke format.                                                                                         |
